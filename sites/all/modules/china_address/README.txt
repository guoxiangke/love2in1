...
2. At admin/build/modules enable the China address module in the Fields 
   package.

INSTALLATION
-------------
1. In the field setting page, choose what kind of level you need to display the field.
