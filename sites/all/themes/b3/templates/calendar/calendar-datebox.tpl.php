...
?>
<?php 
	if (isset($add_content_links)) {
		echo '<span class="calendar-contents-add-links">';
		foreach ($add_content_links as $key => $add_content_link) {
			echo '<span class="calendar-contents-add-link">'.$add_content_link.'</span>';
		}
		echo '</span>';
	}
?>
